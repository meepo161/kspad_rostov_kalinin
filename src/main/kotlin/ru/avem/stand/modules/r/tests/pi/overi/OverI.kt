...
class OverI : KSPADTest(view = OverIView::class, reportTemplate = "overi.xlsx") {
    ...
    override fun initVars() {
        ...
        testModel.specifiedTestTime = 60.0
...
//                    cause = "в течение ${timeout / 1000} секунд значение изменилось меньше, чем на $initPercent%"
    ...
    override fun saveProtocol() {
        ...
        reportFields["FREQ_OVER_I"] = testModel.measuredData.F.value
        reportFields["TOTAL_P_OVER_I"] = testModel.measuredData.P1.value
        reportFields["TOTAL_PF_OVER_I"] = testModel.measuredData.cos.value
        reportFields["RPM_OVER_I"] = testModel.measuredData.RPM.value
        reportFields["TORQUE_OVER_I"] = testModel.measuredData.torque.value
